...
function App() {
  ...
  const { suplementos, refreshKey, agregarSuplemento, marcarTomado, eliminarSuplemento, aplicarRutina } = useSuplementes(session, fecha)
  ...
  return (
    <div className="max-w-xl mx-auto mt-6 px-4 font-sans pb-10">
      ...
      <ul style={{ listStyle: 'none', padding: 0 }}>
        {suplementos.map(s => (
          <SupplementoItem key={s.id} suple={s} onMarcar={marcarTomado} onEliminar={eliminarSuplemento} />
        ))}
      </ul>
