      ...
      {supported && permiso === 'granted' && (
        <>
          <div className="flex items-center justify-between mb-4 p-3 bg-surface-2 border border-white/10 rounded-xl">
            <span id="reminder-toggle-label" className="text-sm text-slate-300">Reminder active</span>
            <button
          ...
          <div className="flex items-center gap-3 mb-4 p-3 bg-surface-2 border border-white/10 rounded-xl">
            ...
            <input
              ...
              disabled={!activa}
              className="px-3 py-1.5 rounded-lg bg-bg border border-white/[0.08] text-slate-200 focus:outline-none focus:border-brand/50 disabled:opacity-40 transition"
            />
          </div>
